...
data1 = pd.read_csv("Electric_Vehicle_Data/Electric_Vehicle_Population_Data.csv")
...
zipCode = []
for i in range(len(data)):
    zipCode.append(data[i]['Postal Code'])
...
years = (1997, 2000, 2003, 2006, 2009, 2012, 2015, 2018, 2021, 2023)
amtPerYear = [year1997, year2000, year2003,year2006, year2009, year2012, year2015,year2018,year2021,year2023]
